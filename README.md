...
1. How would you describe acessibility on the web to someone new to programming?
   ...
   - Responsive design so different devices can access.
   - Accessable for those who are differently abled (colorblind, visually impared, etc...)

2. Talk about 3 different things you can do to ensure your website is accessible.

   - Colors -Red/Green -Contrast
   - Responsive design accomodates various screen sizes.
   - HTML syntax and alt tags for screen readers.
   - heading tags sized appropriately

3. How would you explain the concept of a variable to someone new to programming?

   - Storage for things you'll use later. A container you can reference.

4. What is the purpose of using functions in code?
   - functions hold things apart. It keeps code protected so that it only runs when you want it to.
